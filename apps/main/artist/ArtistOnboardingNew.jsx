...
import { MODAL_CONFIG_PROCESSING } from "../utils/modalstyles";
import { TabsMain } from "../shared/inputs";
...
function ArtistOnboardingNew() {
  ...
  const handleIndExp = (event) => {
    setIndexExp({ value: event.value, label: event.value });
  };

  const HanldlejoiningPurpose = (event) => {
                    ...
                    {errors.gender && (
                      ...
                      <div className="flex gap-5">
                        <div className="w-full mb-8">
                          ...
                          <Select
                            value={GENRES[genreType].filter((obj) =>
