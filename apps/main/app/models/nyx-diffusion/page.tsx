      ...
      {/* <div className="flex absolute -top-[300px] md:top-0 z-0">
        ...
        <div className="w-[90%] h-full md:p-6 my-20 rounded-md">
          <div className="md:mx-6">
            <div className="text-[11px] md:text-[14px] text-white  mt-4 flex">
            <Link href="/models">Models</Link> <BsChevronRight className="mt-1"/> Text To Image <BsChevronRight className="mt-1"/>
