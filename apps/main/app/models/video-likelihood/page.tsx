...
import VideoLikehilood from "../_components/VideoLikelihood";
      ...
      <div className="bg-[#15072a] w-full h-full flex justify-center items-center">
        ...
        <div className="w-[90%] h-full md:p-6 my-20 rounded-md">
          <div className="md:mx-6">
            <div className="text-[11px] md:text-[14px] text-white flex mt-4 ">
            <Link href="/models">Models</Link>  <BsChevronRight className="mt-1"/> Prediction <BsChevronRight className="mt-1"/>
              <span className="text-[11px] md:text-[14px] text-white font-normal">
                NYX Video Likelihood Predictor
              </span>
            </div>
          ...
          <div>
            {diffusionTab == 0 && <VideoLikehilood />}
            {diffusionTab == 1 && <Api />}
