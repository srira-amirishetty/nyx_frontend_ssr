...
import OutpaintingPlayground from "../_components/OutpaintingPlayground";
      ...
      <div className="bg-[#15072a] w-full h-full flex justify-center items-center">
        ...
        <div className="w-[90%] h-full md:p-6 my-20 rounded-md">
          <div className="md:mx-6">
            <div className="text-[11px] md:text-[14px] text-white font-bold mt-4 ">
              Models &gt;{" "}
          ...
          <div>
            {diffusionTab == 0 && <OutpaintingPlayground />}
            {diffusionTab == 1 && <Api />}
