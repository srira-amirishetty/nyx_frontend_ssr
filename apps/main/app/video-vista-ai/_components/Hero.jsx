...
const Hero = () => {
  ...
  const [bgPoster, setBgPoster] = useState(
    `${IMAGE_URL}/assets/images/posters/video-vista-mobile.png`,
  );
  /**
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      if (window.innerWidth > 600) {
        setBgPoster(`${IMAGE_URL}/assets/images/posters/video-poster.png`);
      } else {
        setBgPoster(
          `${IMAGE_URL}/assets/images/posters/video-vista-mobile.png`,
        );
    ...
    >
      {network === "high" && (
        <video
          ...
          ref={videoRef}
          //poster={`${IMAGE_URL}/assets/images/posters/video-poster.png`}
          // poster={
          //   window.innerWidth < 600
          //     ? `${IMAGE_URL}/assets/images/posters/video-vista-mobile.png`
          //     : `${IMAGE_URL}/assets/images/posters/video-poster.png`
          // }
          poster={bgPoster}
          onloadedmetadata={() => setShowPlayButton(true)}
        >
          <source
            src={`${IMAGE_URL}/video/high/VideoVistaAI.mp4`}
            type="video/mp4"
            media="all and (min-width: 640px)"
          />
          <source
            src={`${IMAGE_URL}/video/high/VideoVistaAI.webm`}
            type="video/webm"
            media="all and (min-width: 640px)"
          />
          <source
            src={`${IMAGE_URL}/video/high/VideoVistaAI(Mobile).mp4`}
            type="video/mp4"
            media="all and (max-width: 639px)"
          />
          <source
            src={`${IMAGE_URL}/video/high/VideoVistaAI(Mobile).webm`}
            type="video/webm"
            media="all and (max-width: 639px)"
          />
        </video>
      ...
      {network === "low" && (
        ...
        >
          <source
            src={`${IMAGE_URL}/video/low/VideoVistaAI(720p).mp4`}
            type="video/mp4"
            media="all and (min-width: 640px)"
          />
          <source
            src={`${IMAGE_URL}/video/low/VideoVistaAI(720p).webm`}
            type="video/webm"
            media="all and (min-width: 640px)"
          />
          <source
      ...
      <AnimatePresence>
        {show ? (
          <HeroOverlap onReplay={onReplay} url={""} PageName="VideoVista" />
        ) : null}
      </AnimatePresence>
    </div>
  );
