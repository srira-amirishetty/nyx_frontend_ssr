...
export default function PhoneSignup({
  ...
  useEffect(() => {
    if (isSuccess) {
      ...
      console.log("coutryyyyy", countryCode);
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [isSuccess]);
          ...
          <div className="bg-[#281B37] shadow-md rounded-[30px] h-[480px] p-8">
            ...
            <form>
              ...
              /> */}
                <div className="flex flex-row">
                  ...
                  <input
                    ...
                    className={
                      false
                        ? ` bg-[#ECECEC16]  pt-1 pb-1 pl-2 text-[14px] h-[41px] text-white  rounded-r-md  w-full placeholder-blue border-[#ff5a68] autofill`
                        : `bg-[#ECECEC16]  pt-1 pb-1 rounded-r-md  pl-2 text-[14px] h-[41px] text-white w-full placeholder-blue border-[#8297BD] autofill`
                    }
                    value={number}
                    onChange={phonenumbersubmit}
                    onInput={(e) => {
              ...
              <p className="text-white flex justify-center items-center text-[12px]">
                Use organization email for extra rewards
              </p>
