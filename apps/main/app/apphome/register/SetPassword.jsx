...
export default function SetPassword({
  ...
  useEffect(() => {
    ...
    const isLengthValidMAX = NewPassword.length < 20;


    setIsValid(hasUpperCase && hasSpecialChar && hasNumber && isLengthValid && isLengthValidMAX);
  }, [NewPassword]);
