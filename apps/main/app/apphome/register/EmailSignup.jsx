...
export default function EmailSignup({ RouteRenderPages,ipData }) {
  ...
  return (
    <>
      {!googlescreen ? (
        <div className="sm:w-[350px] w-full " id="form-container-email">
        ...
        <div className="w-full sm:w-[350px]" id="form-container-email">
