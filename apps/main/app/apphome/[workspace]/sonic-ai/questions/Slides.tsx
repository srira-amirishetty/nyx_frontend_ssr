...
import { colourStyles2,colourStylesQuestion } from "../optionsStyle";
export default function Slides({
  ...
  const onLastClose = () => {
    setWarning(false);
    navigate.push(`/apphome/workspace10/sonic-ai/probability?ref=${search.get("processId")}`);
  };
  const notQuit = () => {
    setWarning(false);
  };
    ...
    <>
      ...
      <div className="pt-24 md:pt-20 md:pb-10 relative px-4 z-10">
        ...
        {data.questionType === "DROPDOWN" ? (
          <div className="flex justify-center mx-auto pt-10 z-30">
            {/* <select
