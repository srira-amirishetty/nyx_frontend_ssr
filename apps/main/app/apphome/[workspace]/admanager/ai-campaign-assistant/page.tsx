...
const Page = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const socket = new WebSocket(
      `wss://nyx-ai-api.dev.nyx.today/nyx-ai-chatbot-agents/chat/${localStorage.getItem("workspace_id")}/${sessionStorage.getItem("userId")}`
    );
  ...
  return (
    <div className="w-full h-full px-5 pt-[20px] pb-[30px]">
      <div className="w-full h-[65vh] mt-[14px]">
        <div
          className={cn(
            "w-full",
        ...
        >
          <div
            className={cn(
              "flex flex-col  p-4 max-w-[95%] mx-auto",
          ...
          >
            ...
            <Card
              className={cn(
                ...
                isDark
                  ? "bg-[#332270]/80 border-[#6D28D9]/20"
                  : "bg-white border-gray-200"
              )}
            >
              <CardContent className="p-4 h-full flex flex-col h-[480px] overflow-y-auto custom-scrollbar">
                <style>{`
                ...
                <form onSubmit={handleSubmit} className="flex gap-3">
                  <Input
                    ...
                    className={cn(
                      "flex-1",
                      isDark
                        ? "bg-[#130828BF]/30 border-[#6D28D9]/20 text-purple-200 placeholder:text-purple-300/50"
                  ...
                  <Button
                    ...
                    className={cn(
                      isDark
                        ? "bg-[#5E32FF] hover:bg-[#5B21B6] text-white"
  ...
  return (
    <button
      ...
      className={cn(
        ...
        isDark
          ? "bg-[#130828BF]/30 border-[#6D28D9]/20 hover:bg-[#2D1B69]/50 hover:border-[#6D28D9]/40"
