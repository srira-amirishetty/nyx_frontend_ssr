  ...
  return (
    <>
      <div
        ...
        style={{
          background: "linear-gradient(180deg, #5459FD 0%, #FF7101 100%)", // Adjust the height as needed
        }}
      >
        ...
        <div className="mt-1">
          <img
            src={`${IMAGE_URL}/assets/admanager/Slider.png`}
            alt="previewImage"
            className="w-[250px] h-[2px] object-cover"
          />
        </div>
        ...
        <div className="relative">
          <div className="absolute bottom-16 left-[50%] transform translate-x-[-50%] z-10">
            <div className="w-[147px] h-[34px] bg-white rounded-[8px] flex items-center justify-center gap-[5px]">
              ...
              <p className="font-medium text-[#3576BF] ">Shop Now</p>
            </div>
          </div>
          {/* <img
          ...
          <div className="h-[370px] w-[258px] mt-12">
                    ...
                    <div key={`instapost-${index}`}>
                      {item.type === "images" ? (
                        ...
                        />
                            ...
                            <img
                          src="https://i.ibb.co/0qpcZb8/image-3310.png"
                          alt="previewImage"
                          className="w-full h-[414px] object-cover"
                        />
                </Slider>
          ...
          <div className="h-[37px] bg-black flex justify-center items-center">
            <svg
              width="17"
              height="9"
              fill="none"
            ...
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="m9.295.662 7.111 6.146-1.777 1.536-6.223-5.378-6.222 5.378L.406 6.808 7.518.662c.235-.204.555-.318.888-.318.334 0 .653.114.889.318Z"
                fill="#fff"
              />
            </svg>
          </div>
...
export default InstaShoppingStory;
