...
const FbVideoFeed = ({
  ...
  const handleCheckboxChange = (event) => {
    setFbMarketplaceChecked(event.target.checked);
  };
  let actionLabel =
  ...
  console.log("campaingSiteUrl-------------", campaingSiteUrl);
  return (
    <>
      <div className="flex flex-col items-center justify-center mt-4">
        <div className="w-[258px] h-[40px] bg-[#ECECEC]  flex items-center justify-between">
          ...
          <div className="pr-3">
            <input
              type="checkbox"
              id="fbMarketplaceChecked"
              checked={fbMarketplaceChecked}
              onChange={handleCheckboxChange}
              className="custom-checkbox"
            />
            <label for="fbMarketplaceChecked"></label>
          </div>
        </div>
        ...
        <div className="bg-white w-[258px]  pt-3 pb-1 relative">
          <Image
