  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center mt-4 bg-white">
        ...
        <div
          className="bg-[#FAFAFA] w-[258px] h-[23px] flex items-center p-2 mt-1"
          style={{ boxShadow: "0px 0.23px 0px 0px rgba(60, 60, 67, 0.29)" }}
        >
          <div className=" font-bold text-[9px]">Shop your Favorites</div>
        </div>

        <div className="flex flex-row gap-[2px] w-[258px] bg-white justify-center">
          <div className="w-[84px] h-[84px]">
            <img
              src={previewData[1].image_url}
              alt="previewImage"
        ...
        <div className="mt-1">
          <img
            src={`${IMAGE_URL}/assets/admanager/Fb%20icons%20small.png`}
            alt="previewImage"
            className="w-[258px] h-[33px] object-cover"
          />
        </div>

        <div className="bg-white w-[258px]  relative">
          <Image
