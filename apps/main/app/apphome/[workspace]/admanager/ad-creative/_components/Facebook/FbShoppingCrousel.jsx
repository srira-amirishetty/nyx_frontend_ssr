  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center mt-4 bg-white">
        ...
        <div className=" h-[220px] w-[258px] bg-white mt-1">
          {/* {mixedArray?.length > 0 ? (
          ...
          <Slider {...settings} className="w-full mx-2.5 adCreativeSlider">
            {previewData.map((item, index) => (
              <div key={`${item.name}-${index}`} className="rounded-t-[4px]">
                <div>
                  <img
                    src={item.image_url}
                    alt="previewImage"
                    className="w-[258px] h-[168px] object-cover rounded-t-[4px]"
                  />
                </div>

                <div className="h-[42px] bg-[#F1F2F6] flex flex-row justify-between items-center p-2">
                  <div>
                    <div className="font-semibold text-[8px]">{item.name}</div>
                    <div className="font-medium text-[8px] text-[#9F9F9F]">
                      {item.price}
                    </div>
                  </div>
                  <div className="border-[1.18px] border-[#9F9F9F] p-1 font-semibold text-[8px] rounded-[4.7px]">
                    Shop Now
                  </div>
                </div>
              </div>
...
export default FbShoppingCrousel;
