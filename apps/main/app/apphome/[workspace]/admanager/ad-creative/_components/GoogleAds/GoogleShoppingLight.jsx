        ...
        {googlePreviewData.length >= 4 ? (
          <>
            <div>
              ...
              <div className="w-[477px] h-auto bg-[#FFFFFF]  px-[9px]">
                <div className="flex items-center justify-between mt-4 mb-2">
                  <div className="font-semibold text-[12px]">Sponsored</div>
              ...
              <div className=" h-[300px] w-[477px] bg-white mt-1">
                {/* {mixedArray?.length > 0 ? (
                ...
                >
                  {googlePreviewData?.map((item, index) => (
                    <div key={`${item?.name}-${index}`}>
                      ...
                      <div className="border border-[#E0E4E9] p-2 rounded-b-[12px] w-[143px]">
                        <div
                          className=" w-[125px] h-[40px] font-inter text-[12px] font-medium leading-[13.18px] tracking-[-0.0732px] text-left text-[#1A0DAB] mt-2 line-clamp-3"
                          style={{
                            display: "-webkit-box",
                            WebkitLineClamp: 3,
                        ...
                        <div className="font-inter text-[12px] h-[15px] font-bold leading-[14.52px] tracking-[0.0513px] text-left mt-1">
                          ₹ 
                          {item?.price?.value
                            ? item?.price?.value
                            : "Unable to fetch price"}
                        </div>
                        <div className="font-inter text-[12px] h-[14px] font-semibold leading-[13.18px] tracking-[-0.0732px] text-left text-[#4573FF] mt-[6px]">
          ...
          <>
            <div>
              ...
              <div className="w-auto h-auto bg-[#FFFFFF]  px-[20px] ">
                <div className="flex items-center justify-between mt-4 mb-2">
                  <div className="font-semibold text-[12px]">Sponsored</div>
              ...
              <div className=" h-[300px] w-auto bg-white mt-1 flex flex-row gap-2 px-5">
                {googlePreviewData?.map((item, index) => (
                  <div key={`${item?.name}-${index}`}>
                    <img
                      src={
                    ...
                    <div className="border border-[#E0E4E9] p-2 rounded-b-[12px] w-[143px]">
                      <div
                        className=" w-[125px] font-inter h-[40px] text-[12px] font-medium leading-[13.18px] tracking-[-0.0732px] text-left text-[#1A0DAB] mt-2 line-clamp-3"
                        style={{
                          display: "-webkit-box",
                          WebkitLineClamp: 3,
                          WebkitBoxOrient: "vertical",
                      ...
                      <div className="font-inter text-[12px] font-bold h-[15px] leading-[14.52px] tracking-[0.0513px] text-left mt-1">
                        ₹ 
                        {item?.price?.value
                          ? item?.price?.value
                          : "Unable to fetch price"}
                      </div>
                      <div className="font-inter text-[12px] font-semibold h-[14px] leading-[13.18px] tracking-[-0.0732px] text-left text-[#4573FF] mt-[6px]">
                        {item?.brand ? item?.brand : "brand not available"}
                      </div>
                    </div>
                  </div>
...
export default GoogleShoppingLight;
