      ...
      <div className="flex flex-col items-center justify-center mt-4 bg-white">
        ...
        <div className="w-[258px] h-auto bg-[#FFFFFF]  px-[9px]">
          <div className="flex items-center justify-between ">
            <div className="flex items-center gap-[3px]">
              ...
              />
              <div>
                <p className="text-[#0D0C0C] font-semibold text-[9.54px] leading-[10.86px]">
                  {brandName}
                </p>
          ...
          <p className="text-[#4B4A4A] font-normal text-[8px] leading-[10.86px] mt-[5px]">
            {headlines}
          </p>
          <p className="text-[#4B4A4A] font-normal text-[8px] leading-[10.86px] mt-[5px]">
            Show Now:{" "}
            <span className=" text-[#5E32FF]">{previewData[0].url}</span>
          </p>
          <p className="text-[#4B4A4A] font-normal text-[7.84px] leading-[10.86px] ">
            {captions}...{" "}
            <span className="text-[#14110E] font-bold">See More</span>
          </p>
        </div>

        <div className=" h-[258px] w-[258px] bg-white mt-1">
          {/* {mixedArray?.length > 0 ? (
        ...
        <div className="bg-white w-[258px] ">
          <div className="bg-[#EEF3F8] w-full h-[45px] flex items-center justify-between px-[9px] py-[6px]">
            <div>
              <p className="text-[8px] leading-[8px] font-semibold text-[#191919] mb-1 break-all">
                {previewData[0].name}
              </p>
              <p className="text-[8px] w-[168px] leading-[13.32px] font-semibold text-[#000000] opacity-[60%] mb-1 truncate ">
                {descriptions}
              </p>
            </div>
            <div>
              <button className="w-[50px] h-[15px] bg-gray-300 py-2 flex items-center justify-center text-[8px] leading-[10px] text-[#000] font-semibold rounded-sm">
                Shop Now
              </button>
            </div>
          </div>
        ...
        {/* likes and commets */}
        <div className="mt-2 w-[258px] flex items-center">
          <img
            src={`${IMAGE_URL}/assets/admanager/Fb%20icons%20large.png`}
            alt="previewImage"
            className="w-[258px] h-[21px] object-cover"
          />
        </div>

        <div className="bg-white w-[258px]   border-opacity-50 border-[0.5px] px-2  relative border-t border-solid border-[#D2C7C7]">
          <Image
...
export default FbShoppingSingle;
