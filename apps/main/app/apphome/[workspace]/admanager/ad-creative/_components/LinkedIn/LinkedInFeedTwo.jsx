...
const LinkedIn2 = ({
  ...
  const handleCheckboxChange = (event) => {
    setLinkedinFeedTwoChecked(event.target.checked);
  };
  let actionLabel =
        ...
        <div className="relative w-[213px] h-auto bg-[#FFFFFF] ">
          <div className="absolute top-2 right-2">
            <div className="">
              <input
                type="checkbox"
                id="linkedinFeedTwoChecked"
                checked={linkedinFeedTwoChecked}
                onChange={handleCheckboxChange}
                className="custom-checkbox"
              />
              <label for="linkedinFeedTwoChecked"></label>
            </div>
          </div>
          ...
          <div className="w-full h-[114px] max-w-[213px]">
