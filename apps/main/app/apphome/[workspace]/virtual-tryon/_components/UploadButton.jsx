...
function UploadButton({
  ...
  const handledriveImage=()=>{

    setUploadedFile("https://storage.googleapis.com/nyxassets-new/assets/images/model/sample/bg-inside-1.png")
    setImageSource("gcp")
    setAddProductPopup(false);
  }
        ...
        <>
          {imageSource=="system" ?(
            ...
            <img
              ...
              alt="Uploaded"
              className=" object-contain h-[288px] w-[316px]"
            />
            <button
              className="absolute top-0 right-4 bg-black text-white rounded-full p-1 m-2 focus:outline-none"
        ...
        <>
          <div className="flex flex-col w-full justify-center items-center">
            <div
              ...
              className="relative h-[288px] w-[316px] rounded-md m-auto bg-gradient-to-r mt-1 from-gray-300/40 to-gray-500/25 flex justify-evenly flex-col items-center z-0 gap-2 cursor-default"
            ...
            >
              ...
              <div className="flex flex-col items-center">
                <span className="text-white absolute top-4">{title}</span>
                ...
                <div className="z-50 text-white text-[14px] mt-2 font-normal text-center px-[70px]">
        ...
        >
          <div>
            <div className="flex justify-between mt-5">
              ...
              <div className="pr-3 cursor-pointer" onClick={closeProductPopup}>
                <svg
            ...
            <div className="flex flex-col justify-between w-full">
              ...
              <div className="flex flex-col gap-3">
                ...
                onClick={handledriveImage} disabled={true} >

                  Upload from drive
                </Button>
                <label htmlFor={inputId}>
                  <div className="w-full rounded-full text-center border-nyx-yellow  text-nyx-yellow hover:shadow-none font-semibold  border-[1px] py-2 hover:bg-nyx-yellow hover:text-black cursor-pointer">
                    Browse from System
                  </div>
                  <input
                    id={inputId}
