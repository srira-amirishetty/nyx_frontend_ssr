...
function OwnModelBtn({ id,uploadedFile,setUploadedFile,height,text}) {
        ...
        {imageSource=="system" ? (
          <div className="relative flex items-center justify-center mt-1">
            <img
              ...
              alt="Uploaded"
              className={`w-full h-[${height}px] object-fill`}
            />
            <button
        ...
        <>
          <div className="flex flex-col w-full justify-center items-center gap-5">
            ...
            onClick={openProductPopup}
              ...
              className={`relative cursor-pointer h-[${height}px] w-full rounded-lg m-auto  mt-1  flex justify-evenly flex-col items-center z-0  gap-3 cursor-default `}
              style={{
  background: "linear-gradient(108.46deg, rgba(255, 255, 255, 0.264) 0%, rgba(255, 255, 255, 0.066) 100%)",boxShadow: "0px 4px 6px -2px rgba(0, 0, 0, 0.25)"
            ...
            >
              <div className="flex flex-col items-center">
                ...
                <div className="text-[#FFFFFF] z-50 text-[14px] mt-2 font-light text-center leading-[17px]">
                  {text}
                </div>
              </div>
