  ...
  return (
    <div className="inline-block relative z-10" ref={ref}>
      ...
      >
        ...
        <div className="w-[100px] h-[80px] bg-[#6F559A] rounded-t-xl flex justify-center items-center p-3">
          <div className="border border-nyx-yellow text-nyx-yellow transition-all rounded-full p-1">
            <svg
              viewBox="0 0 17 17"
              className="w-5 h-5 fill-current text-nyx-yellow"
              fill="none"
        ...
        <div className="text-xs text-[#FFFFFF] w-[100px] h-[30px] bg-[#1D1138] rounded-b-xl flex items-center justify-center">
          Add New
        </div>
      </button>
      <div
        className={classNames(
          "absolute z-20 text-gray-950 top-[-100px] rounded-md p-2 bg-white",
          open ? "" : "hidden",
        )}
      >
