...
function VtonOutput2( { vtonResponse2,selectedTab }: any) {
  ...
  useEffect(() => {
    ...
    Object.keys(vtonResponse2.file_id).forEach((tab) => {
  ...
  const onChange = (option: any) => {
    if (option.value === "Open with Brand Canvas") {
      ...
      localStorage.setItem(
        imageID,
        vtonResponse2.generated_photos.output_image["full_body_back"],
      );
      window.open(
          ...
          <div className="flex gap-1 pr-2">
            ...
            <div className="relative group/button">
              <button
                data-testid="save"
                className={` text-[#FFFFFF] border rounded-full p-2 focus:outline-none hover:bg-nyx-sky hover:border-nyx-sky active:bg-nyx-sky active:border-nyx-sky`}
                onClick={() => saveImage(vtonResponse2.file_id["full_body_back"])}
              >
                <svg
                  width="20"
                  height="20"
            ...
            <div className="relative group/button">
              <button
                ...
                onClick={() =>
                  dislikeImage(vtonResponse2.file_id["full_body_back"], "full_body_back")
                }
              >
                <svg
                  width="20"
            ...
            <div className="relative group/button">
              <button
                ...
                onClick={() =>
                  likeImage(vtonResponse2.file_id["full_body_back"], "full_body_back")
                }
              >
                <svg
                  width="21"
