...
interface MetaUploadModalProps {
  ...
  gmcId: any;
  setGmcId: any;
  googleLinkLoading: any;
  googleFileLoading: any;
}
      ...
      {selectedTab === "Upload from sheet" && (
        <div>
            ...
            <div className="w-full ">
              <Select
                ...
                value={gmcOption.find(
                  (option: any) => option.value === String(gmcId),
                )}
                onChange={(selectedOption: any) => {
                  if (selectedOption) {
                    setGmcId(selectedOption.value);
                  }
                }}
                components={{
          ...
          <div className="w-full flex justify-center">
            ...
            >
              {googleFileLoading ? "Loading..." : "Submit"}
            </button>
          </div>
        </div>
      )}
      ...
      {selectedTab === "Upload via link" && (
        <div>
          ...
          <div className="w-full flex justify-center">
            ...
            >
              {googleLinkLoading ? "Loading..." : "Submit"}
            </button>
          </div>
        </div>
      )}
