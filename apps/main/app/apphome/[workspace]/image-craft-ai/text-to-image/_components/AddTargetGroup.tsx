        ...
        <div className="w-full flex flex-col gap-2">
          ...
          <input
            ...
            {...register("targetGroupName", {
              required: "Target Group Name is required",
              maxLength: {
                value: 15,
          ...
          {errors.targetGroupName && (
            <p className="text-nyx-red text-xs">
              {/* {errors.targetGroupName.message} */}
              {String(errors.targetGroupName.message)}
            </p>
          )}
        </div>
        <div className="w-full flex flex-col gap-2">
              ...
              <div key={`target-group-gender-${item?.name}`} className="w-full">
                ...
                <label
                  ...
                  className={classNames(
                    ...
                    "bg-[#543891] text-white peer-checked:bg-nyx-sky peer-checked:text-nyx-yellow"
                  )}
                >
                  {item?.name}
                </label>
