...
const Steper = ({ tab = "", imageUploaded }) => {
  console.log("tab", tab);
  const [progressstep, setprogressstep] = useState(0);
  useEffect(() => {
    if (tab === "camaign" && imageUploaded == false) {
      setprogressstep(0);
    } else if (tab === "upload" && imageUploaded == false) {
      setprogressstep(1);
  ...
  return (
    <>
      <div className="flex justify-start mt-12 items-center overflow-y-auto italic mb-8">
        <ol className="overflow-hidden space-y-4">
          ...
          <Step
            ...
            title={"Define campaign objective and target audiences"}
          ...
          <Step
            ...
            hasAfter={false}
            title={"Get the detailed creative analysis"}
          />
        </ol>
      </div>
    </>
