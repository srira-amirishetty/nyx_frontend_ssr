  ...
  return (
    <button
      className={classNames(
        `group relative w-auto font-medium p-2 rounded-md flex items-center gap-2 cursor-pointer  hover:shadow-gray-800 shadow-none hover:shadow-md`,
        isActive ? "bg-[#5E32FF] text-nyx-yellow " : "bg-[#1D1138] text-white",
      )}
      onClick={onClickHandler}
      title={brand.brand_name}
    >
      <div className="text-sm w-full">{brand.brand_name}</div>
      <div
