    ...
    <div className="w-full flex flex-col gap-1 justify-center items-center">
      <button
        ...
        className={classNames(
          ...
          props.active?.id === props.id ? "bg-[#5E32FF]" : "bg-[#6F559A]",
        )}
        onClick={onClickHandler}
      ></button>
      <div
        className={classNames(
          "w-full text-center text-white text-xs",
          props.active?.id === props.id ? "font-bold" : "font-normal",
        )}
      >
        {props?.title}
      </div>
      <div
        className={classNames(
          ...
          props.active?.id === props.id ? "font-bold" : "font-light",
        )}
      >
        {`(${props?.diamension})`}
      </div>
