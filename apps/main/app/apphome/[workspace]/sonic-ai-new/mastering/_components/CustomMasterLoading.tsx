...
const MasterModal = (
  ...
  useEffect(() => {
    timerID.current = setTimeout(() => {
      if (Object.keys(mutateCustomMastering?.data?.nyx_mastered || {}).length) {
        onEndHandler();
      } else {
        if (progress < 99) {
  ...
  }, [progress, mutateCustomMastering]);
