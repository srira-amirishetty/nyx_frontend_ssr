...
const Steper = ({
  ...
  }, [selectedGenre, originalSuccess, referenceSuccess, showMasterLoading]);

  return (
    <>
      <div className="flex flex-col overflow-y-auto">
        <p className="w-full text-white text-xl font-semibold my-5">
          Steps for Enhancing/Mastering a Song
        </p>
        <ol className="overflow-hidden space-y-4 italic">
          ...
          <Step
            ...
            title={"Select/add reference music"}
            lineActive={progressstep >= 3}
          />
          <Step
            isActive={progressstep >= 4}
            title={"Enjoy your song with interactive analysis"}
