...
const CustomAudio = ({ url, name }: any) => {
  ...
  const downloadSong = async (songUrl: any) => {
    try {
    ...
    <>
      <div className="w-full h-[190px] p-2 rounded-md bg-[#28134B] flex flex-col justify-between items-center">
        ...
        <div className="audio-player w-full ">
          ...
          <div className="flex w-full justify-between text-white font-light cursor-pointer">
