        ...
        >
          <div className="flex flex-col mt-2">
                ...
                {originalSuccess ? (
                  <div className="flex flex-col">
                    ...
                    <div className="w-full h-[30px] bg-[#5E32FF] rounded-b-lg text-center text-sm">
                     <p className="mt-1 truncate"> {originalsongname}</p>
                    </div>
                  </div>
                ) : (
                  <button
            ...
            <p className="flex justify-start items-start text-[10px]  font-normal italic ml-6 mr-6 text-white">
              ...
              top of the home page. The song will then be sent to our AI engine.
            </p>
          </div>
          ...
          <Button
              className={
                originalSuccess 
                  ? `rounded-full  w-[200px] text-[14px] mb-4  hover:shadow-none text-[black] bg-[#FFC01D] font-regular py-[8px]  disabled:cursor-not-allowed disabled:bg-nyx-gray-1 disabled:border-none font-semibold`
                  : `rounded-full  w-[200px] text-[14px] mb-4 hover:bg-nyx-gray-1  hover:shadow-none text-black font-regular py-[8px] cursor-not-allowed bg-nyx-gray-1 border-none font-semibold`
              }
              onClick={predictClick}
              disabled={originalSuccess ? false : true}
            >
              Predict Virality
            </Button>
