  ...
  return (
    <div
      className={classNames(
        "border border-black w-[260px] h-[300px] lg:w-full relative ",
        className,
      )}
    >
      <h3 className="text-white m-[9px] absolute left-10">{title}</h3>
      <div className="w-[260px] h-[300px] p-[10px] flex justify-center items-center mx-auto">
        {children}
      </div>
    </div>
  );
