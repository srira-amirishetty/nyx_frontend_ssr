...
const SetpasswordEmail = ({
  SignupEmailSetpassPopUp,
  closePopUp,
  showPasswordemailpassset,
  PasswordNotMatchedemailpassset,
  NewPasswordemailpassset,
  NewPasswordChangeemailpassset,
  handleClickShowPasswordemailpassset,
  isValidemailpassset,
  showPassword2emailpassset,
  ConfirmPasswordemailpassset,
  ConfirmPasswordChangeemailpassset,
  handleClickShowPassword2emailpassset,
  updatebuttonclickemailpassset,
}) => {
  return (
    <>
      {SignupEmailSetpassPopUp ? (
        <Modal
          isOpen={SignupEmailSetpassPopUp}
          ...
          <div className="bg-[#281b37] shadow-md rounded-[30px] p-8 px-[20px] w-[350px] h-[500px] sm:w-[350px] sm:h-[500px]">
            ...
            <form>
              <div className="mb-4">
                ...
                <input
                  type={showPasswordemailpassset ? "text" : "password"}
                  className={
                    PasswordNotMatchedemailpassset
                  ...
                  value={NewPasswordemailpassset}
                  onChange={NewPasswordChangeemailpassset}
                />
                <span
                  onClick={handleClickShowPasswordemailpassset}
              ...
              <div className="mb-1">
                ...
                <input
                  type={showPassword2emailpassset ? "text" : "password"}
                  className={
                    PasswordNotMatchedemailpassset
                      ? `border py-3 pl-2 text-[14px] h-[40px] text-white bg-transparent rounded-md w-full placeholder-blue border-[#ff5757]`
                      : `border py-3 pl-2 text-[14px] h-[40px] text-white bg-transparent rounded-md w-full placeholder-blue border-[#8297BD]`
                  ...
                  placeholder="xxxxxxxxx"
                  value={ConfirmPasswordemailpassset}
                  onChange={ConfirmPasswordChangeemailpassset}
                />
                {PasswordNotMatchedemailpassset ? (
                ...
                <span
                  onClick={handleClickShowPassword2emailpassset}
                  className="absolute ml-[-24px] mt-[10px] "
                >
                  {showPassword2emailpassset ? (
                    <AiFillEye className="cursor-pointer text-lg text-blue" />
              ...
              <div className="mb-6 mt-6 text-center">
                <button
                  ...
                  onClick={updatebuttonclickemailpassset}
                >
                  Sign Up
                </button>
              </div>
