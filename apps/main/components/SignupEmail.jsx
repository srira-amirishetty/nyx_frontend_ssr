...
const SignupPhone = ({
  SignupEmailPopUp,
  closePopUp,
  wrongpasswordsignupemail,
  numberemailsignup,
  phonenumberemailsignup,
  wrongpasswordsignupemailcheck,
  GetOTPEmailsignup,
            ...
            <form>
              <div className="mb-4">
                ...
                <input
                  ...
                  value={numberemailsignup}
                  onChange={phonenumberemailsignup}
                />
                {wrongpasswordsignupemailcheck ? (
