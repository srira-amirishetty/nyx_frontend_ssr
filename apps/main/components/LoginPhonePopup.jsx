          ...
          <div className="bg-[#281b37] shadow-md rounded-[30px] p-8 px-[20px] w-[350px] h-[500px] sm:w-[350px] sm:h-[500px]">
            ...
            <form>
              <div className="mb-4">
                ...
                {wrongnumber ? (
                  <p className="text-[#ff4545] text-[10px] font-normal absolute  mt-[-20px]">
              ...
              <div className="flex justify-end mb-6">
                <p
                  ...
                  onClick={phoneForgotpaswordButton}
                >
                  Forgot Password?
                </p>
              </div>
...
export default LoginPhonePopup;
