...
const OtpEmailSignup = ({
  SignupEmailOTPPopUp,
  closePopUp,
  backButtonemailsignup,
  wrongpasswordemailotp,
  userexistedemailotp,
  notfilledemailotp,
  OTPvalueemailsignup,
  OTPHandelChangeemailsignup,
  resendOTPemailsignup,
  VerifyOTPemailsignup,
  closeSignupEmailOTPPopUp,
}) => {
  return (
    <>
      {SignupEmailOTPPopUp ? (
        <Modal
          isOpen={SignupEmailOTPPopUp}
        ...
        >
          <div className="bg-[#281b37] shadow-md rounded-[30px] p-8 px-[20px] w-[350px] h-[500px] sm:w-[350px] sm:h-[500px]">
            <div
              onClick={backButtonemailsignup}
              className="svg-icon ml-[-14px] cursor-pointer absolute"
              dangerouslySetInnerHTML={{ __html: icon }}
            ></div>
            <div
              onClick={closeSignupEmailOTPPopUp}
            ...
            <form>
              <div className="mb-4">
                ...
                <input
                  ...
                  placeholder="xxxxxx"
                  value={OTPvalueemailsignup}
                  onChange={OTPHandelChangeemailsignup}
                />
                {wrongpasswordemailotp ? (
