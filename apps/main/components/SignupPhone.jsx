...
const SignupPhone = ({
  ...
  closePopUp,
  countriesOptions,
  countrySelectOnChangeHandler,
  wrongpasswordsignupphone,
  numberphonesignup,
  phonenumberphonesignup,
  wrongpasswordsignupphonecheck,
  GetOTPPhonesignup,
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-row">
                  ...
                  <input
                    ...
                    className={
                      wrongpasswordsignupphone
                        ? `border pt-1 pb-1 pl-2 text-[14px] h-[40px] text-white bg-transparent rounded-r-md  w-full placeholder-blue border-[#ff5a68]`
                        : `border pt-1 pb-1 rounded-r-md  pl-2 text-[14px] h-[40px] text-white bg-transparent w-full placeholder-blue border-[#8297BD]`
                    }
                    value={numberphonesignup}
                    onChange={phonenumberphonesignup}
                  />
                </div>
                {wrongpasswordsignupphonecheck ? (
