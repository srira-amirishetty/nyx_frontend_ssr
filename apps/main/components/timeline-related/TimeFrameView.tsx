...
export const TimeFrameView = observer((props: { element: EditorElement }) => {
  ...
  return (
    <div
      ...
      key={element.id}
      className={`relative width-full h-[25px] my-2 group ${
    ...
    >
      ...
      <button
        className="hidden group-hover:block bg-red-500 hover:bg-red-700 text-white mr-2 text-xs py-0 px-1 rounded absolute -right-1 top-0.5"
        onClick={(e) => {
