        ...
        >
          <div className="bg-[#281b37] shadow-md rounded-[30px] p-8 px-[20px] w-[350px] h-[500px] sm:w-[350px] sm:h-[500px]">
            ...
            <form>
              ...
              <div className="mb-6 flex justify-around text-center mt-8">
                <p
                  className="text-[14px] underline text-white cursor-pointer "
                  onClick={resendOTP}
                >
                  Resend OTP
                </p>
