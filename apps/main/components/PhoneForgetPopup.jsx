...
const PhoneForgetPopup = ({
  phoneForgetPopUp,
  closePopUp,
  countriesOptions,
  countrySelectOnChangeHandler,
  wrongpasswordForgetPhone,
  numberForgetPhone,
  phonenumbersubmitForgetPhone,
  wrongnumberForgetPhone,
  GetOTPPhone,
  SigninWithEmailButtonForgot,
  previousForgetPhone,
  closeForgetPhone,
}) => {
  return (
            ...
            <form>
              <div className="mb-4">
                ...
                <div className="flex flex-row">
                  ...
                  <input
                    ...
                    value={numberForgetPhone}
                    onChange={phonenumbersubmitForgetPhone}
                  />
                </div>
                {wrongpasswordForgetPhone ? (
              ...
              <div className="text-center text-white mt-6">
                ...
                <div className="mt-6 flex justify-center gap-x-5 items-center">
                  <div
                    onClick={SigninWithEmailButtonForgot}
...
export default PhoneForgetPopup;
