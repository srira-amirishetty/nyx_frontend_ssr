...
const SetpasswordPhone = ({
  SignupPhoneSetpassPopUp,
  closePopUp,
  showPasswordphonepassset,
  PasswordNotMatchedphonepassset,
  NewPasswordphonepassset,
  NewPasswordChangephonepassset,
  handleClickShowPasswordphonepassset,
  isValidphonepassset,
  showPassword2phonepassset,
  ConfirmPasswordphonepassset,
  ConfirmPasswordChangephonepassset,
  handleClickShowPassword2phonepassset,
  updatebuttonclickphonepassset,
}) => {
  return (
    <>
      {SignupPhoneSetpassPopUp ? (
        <Modal
          isOpen={SignupPhoneSetpassPopUp}
          ...
          <div className="bg-[#281b37] shadow-md rounded-[30px] p-8 px-[20px] w-[350px] h-[500px] sm:w-[350px] sm:h-[500px]">
            ...
            <form>
              <div className="mb-4">
                ...
                <input
                  type={showPasswordphonepassset ? "text" : "password"}
                  className={
                    PasswordNotMatchedphonepassset
                  ...
                  value={NewPasswordphonepassset}
                  onChange={NewPasswordChangephonepassset}
                />
                <span
                  onClick={handleClickShowPasswordphonepassset}
              ...
              <div className="mb-1">
                ...
                <input
                  type={showPassword2phonepassset ? "text" : "password"}
                  className={
                    PasswordNotMatchedphonepassset
                      ? `border py-3 pl-2 text-[14px] h-[40px] text-white bg-transparent rounded-md w-full placeholder-blue border-[#ff5757]`
                      : `border py-3 pl-2 text-[14px] h-[40px] text-white bg-transparent rounded-md w-full placeholder-blue border-[#8297BD]`
                  ...
                  placeholder="xxxxxxxxx"
                  value={ConfirmPasswordphonepassset}
                  onChange={ConfirmPasswordChangephonepassset}
                />
                {PasswordNotMatchedphonepassset ? (
                ...
                <span
                  onClick={handleClickShowPassword2phonepassset}
                  className="absolute ml-[-24px] mt-[10px] "
                >
                  {showPassword2phonepassset ? (
                    <AiFillEye className="cursor-pointer text-lg text-blue" />
              ...
              <div className="mb-6 mt-6 text-center">
                <button
                  ...
                  onClick={updatebuttonclickphonepassset}
                >
                  Sign Up
                </button>
              </div>
...
export default SetpasswordPhone;
